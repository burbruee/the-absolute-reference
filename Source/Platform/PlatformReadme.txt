...
PlatformUpdate.h and PlatformTypes.h. Check existing platform implementations
for info on what has to be defined in those headers; the PsikyoSH version is
the reference all other platforms need to conform to. Your platform's own code
goes in the platform's top directory ("SDL2") or subdirectories other than
"PlatformSupport".
