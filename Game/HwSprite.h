...
#define SPRITE_GETPAL(sprite) ((uint8_t)(((sprite)[4] >> 8) & 0xFF))
...
#define SPRITE_SETX(sprite, x) ((sprite)[0] = ((sprite)[1] & ~0x03FF) | ((uint16_t)(x) & 0x3FF))
...
#define SPRITE_SETPAL(sprite, palNum) ((sprite)[4] = ((sprite)[4] & ~0xFF00) | (((uint16_t)(palNum) & 0xFF) << 8))
